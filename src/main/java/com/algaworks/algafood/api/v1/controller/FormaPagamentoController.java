...
//	}
    ...
    public ResponseEntity<CollectionModel<FormaPagamentoModel>> listar(ServletWebRequest request) {
    	...
    	//Deep ETagg - chache fundo
    	
    	ShallowEtagHeaderFilter.disableContentCaching(request.getRequest()); // para desabilitar o ShallowETag
		...
		if (request.checkNotModified(eTag)) {
			//checkNotModified compara o If-None-Match com a eTag
			return null;
		}
