...
public class RestauranteModelAssembler extends RepresentationModelAssemblerSupport<Restaurante, RestauranteModel> {
	...
	//Biblioteca para converter objetos (ModelMapper. Com ele é possível mapear modelos complexos, com nenhuma ou poucas configurações – sempre seguindo convenções.).
