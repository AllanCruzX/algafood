...
public class Problem {
	...
	// @JsonInclude(Include.NON_NULL) - só inclui no json as propriedades que não
	// estiverem null.

	@ApiModelProperty(example = "400", position = 1)
	private Integer status;

	@ApiModelProperty(example = "2019-12-01T18:09:02.70844Z", position = 5 ,value = "Data e hora no formato ISO" )
