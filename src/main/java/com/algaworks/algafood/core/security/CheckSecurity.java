...
public @interface CheckSecurity {
    ...
    public @interface Pedidos {
    	...
    	//@PostAuthorize - faz a checagem depois da execução do metodo.
    	//returnObject - variavel impricita que retorna o objeto de reposta do metodo (Só funciona no PostAuthorize).
