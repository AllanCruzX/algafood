...
public class RestauranteRepositoryImpl implements RestauranteRepositoryQueries {
	 ...
	 * taxaFreteInicial, BigDecimal taxaFreteFinal) { var builder =
	 * manager.getCriteriaBuilder();
	 * 
	 * var criteria = builder.createQuery(Restaurante.class); var root =
	 ...
	 * 
	 * var query = manager.createQuery(criteria); return query.getResultList(); }
	 */
